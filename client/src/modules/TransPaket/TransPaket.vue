...
import NavSubmenu from '@/modules/TransPaket/Widget/NavSubmenu.vue';

// Import komponen tab
import PageDaftarPaket from '@/modules/TransPaket/Widget/PageDaftarPaket.vue';
import PageDaftarJamaah from '@/modules/TransPaket/Widget/PageDaftarJamaah.vue';
import PagePembayaranPaket from '@/modules/TransPaket/Widget/PagePembayaranPaket.vue';
import PagePembayaranPaketAgen from '@/modules/TransPaket/Widget/PagePembayaranPaketAgen.vue';
...
<template>
  <div v-if="isVisible" class="pl-4 pr-4 flex flex-col h-full">
    ...
    <template v-if="current === 'detail_paket'">
      <component
        :is="currentComponent"
        @showDetailPaket="handleShowDetailPaket"
        @closeDetailPaket="handleCloseDetailPaket"
