  ...
  >
    <div v-if="!isLoading && data">
      ...
      <div class="rounded p-0 bg-white mb-6">
        ...
        <table
          class="w-full text-center border-collapse mb-6 text-xs print:text-xs border-b border-gray-300"
        >
          <thead class="bg-gray-100">
            <tr>
              <th class="border-b border-t border-s font-medium border-gray-300 p-2 w-[20%]">
                Tanggal
              </th>
              ...
              <th class="border-b border-t border-e font-medium border-gray-300 p-2 w-[10%]">
                Jumlah
              </th>
            </tr>
          </thead>
          ...
          <tfoot>
            <tr>
              <td colspan="4" class="border-b border-gray-300 p-2 text-right font-bold">
                <i>Total Pembayaran</i>
              </td>
              <td class="border-b border-gray-300 p-2 font-normal">
