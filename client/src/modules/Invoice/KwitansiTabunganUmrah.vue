  ...
  >
    <div v-if="!isLoading && data">
      ...
      <div class="border rounded p-4 bg-white shadow-sm mb-6">
        ...
        <table
          class="w-full text-center border border-collapse mb-6 text-sm print:text-xs border-b border-gray-300"
        >
          ...
          <tbody>
            <tr>
              ...
              <td class="border-b border-gray-300 p-2">
                {{ formatCurrency(data.nominal_tabungan) }}
              </td>
            </tr>
          </tbody>
          <tfoot>
            <tr>
              ...
              <td class="border-b border-gray-300 p-2">
                {{ formatCurrency(data.saldo_tabungan_sebelum) }}
              </td>
            </tr>
            <tr>
              ...
              <td class="border-b border-gray-300 p-2 font-bold">
                {{ formatCurrency(data.saldo_tabungan_sesudah) }}
              </td>
            </tr>
          </tfoot>
        </table>
