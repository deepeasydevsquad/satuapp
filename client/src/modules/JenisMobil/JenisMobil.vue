...
// Import Icon
import DeleteIcon from '@/modules/JenisMobil/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/JenisMobil/Icon/EditIcon.vue';

// import element
import Form from '@/modules/JenisMobil/Widget/Form.vue';
import DangerButton from '@/modules/JenisMobil/Particle/DangerButton.vue';
import Notification from '@/modules/JenisMobil/Particle/Notification.vue';
import Confirmation from '@/modules/JenisMobil/Particle/Confirmation.vue';
...
// Import service API
import { daftarJenisMobil, deleteJenisMobil } from '@/service/jenis_mobil'; // Import function POST
...
const fetchData = async () => {
  const response = await daftarJenisMobil({
    search: search.value,
  ...
  <div class="container mx-auto p-4">
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
          <tr>
            <th class="w-[90%] px-6 py-4 font-medium font-bold text-gray-900 text-center">
              Nama Jenis Mobil
            </th>
    ...
    >
      <Form
        ...
        :selected-jenis-mobil="selectedJenisMobil"
        @close="
          isModalOpen = false;
          fetchData();
        "
        @status="
          (payload) =>
            displayNotification(
              payload.err_msg || 'Tambah atau Update Jenis Mobil gagal',
