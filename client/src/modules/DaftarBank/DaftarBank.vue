...
// Import Icon
import DeleteIcon from '@/modules/DaftarBank/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/DaftarBank/Icon/EditIcon.vue';

// import element
import DangerButton from '@/modules/DaftarBank/Particle/DangerButton.vue';
import Notification from '@/modules/DaftarBank/Particle/Notification.vue';
import Confirmation from '@/modules/DaftarBank/Particle/Confirmation.vue';

import Form from '@/modules/DaftarBank/Widget/Form.vue';
      ...
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
          <tr>
            ...
            <th class="w-[40%] px-6 py-4 font-medium font-bold text-gray-900 text-center">
              Nama Bank
            </th>
    ...
    >
      <Form
        ...
        @status="
          (payload) =>
            displayNotification(
              payload.err_msg || 'Tambah atau Update Bank gagal',
