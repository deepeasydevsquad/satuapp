...
import { getAgen, getInfoMember, getJamaahNotMember, addJamaah } from '@/service/daftar_jamaah';
...
const fetchData = async () => {
  if (!props.cabangId || !props.memberId) {
    displayNotification(
      'ID cabang dan member tidak ditemukan, silakan keluar dan masuk kembali.',
      'error',
    );
    return;
  }
...
<template>
  <div
    v-if="props.isFormMemberOpen && !isLoading"
  ...
  >
    ...
    >
      ...
      >
      <div
        class="relative p-6 inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-4xl sm:align-middle max-h-[80vh] overflow-y-auto no-scrollbar"
      >
        <h1
        ...
        <!-- Catatan -->
        <div
          class="bg-yellow-100 border-l-4 border-yellow-400 p-4 text-sm text-gray-800 rounded-lg text-left"
        >
          ...
          <ul class="list-disc pl-5 space-y-1">
            ...
            <li>
              Jika jamaah memiliki agen, anda wajib memilih agen terlebih dahulu sebelum melakukan
              transaksi. Jika tidak mengisi nama agen, maka transaksi yang sudah anda lakukan tidak
              menambahkan fee kepada Agen.
            </li>
          </ul>
        </div>
        ...
        <table
          class="w-full bg-white text-sm text-gray-700 border border-gray-200 rounded-lg overflow-hidden"
        >
          <tbody>
            <tr>
              <td rowspan="7" class="w-[15%] p-4 align-top border-r border-gray-200 bg-gray-50">
                <div class="flex justify-center items-start">
                  <div
                    class="w-40 max-h-[10vw] rounded-md overflow-hidden border border-dashed border-gray-300 bg-gray-100 flex items-center justify-center"
                  >
                    <img
                    ...
                    <div
                      v-else
                      class="text-gray-400 text-sm min-h-[10vw] flex items-center justify-center"
                    >
                      <p>Tidak ada foto</p>
                    </div>
                  </div>
