...
import { getAgen, getJamaahNotMember, addJamaah } from '@/service/daftar_jamaah';
...
const fetchData = async () => {
  ...
  try {
    ...
    const [cabangRes, agenRes, provinsiRes, mahramRes, pekerjaanRes, pendidikanRes, pengalamanRes] =
      await Promise.all([
        paramCabang(),
...
<template>
  ...
  <div
    v-if="props.isFormAddOpen && !isLoading"
