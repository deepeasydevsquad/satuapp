...
// Import Icon
import DeleteIcon from '@/modules/DaftarKota/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/DaftarKota/Icon/EditIcon.vue';

// import element
import Form from '@/modules/DaftarKota/Widget/Form.vue';
import DangerButton from '@/modules/DaftarKota/Particle/DangerButton.vue';
import Notification from '@/modules/DaftarKota/Particle/Notification.vue';
import Confirmation from '@/modules/DaftarKota/Particle/Confirmation.vue';
    ...
    <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md">
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-50">
          <tr>
            <th class="w-[75%] px-6 py-4 font-medium font-bold text-gray-900 text-center">
              Nama Kota
            </th>
    ...
    >
      <Form
        ...
        @status="
          (payload) =>
            displayNotification(
              payload.err_msg || 'Tambah atau Update Kota gagal',
