...
import Header from '@/modules/TabunganUmrah/Particle/Header.vue';
import Footer from '@/modules/TabunganUmrah/Particle/Footer.vue';
        ...
        <div class="flex gap-10">
          ...
          <div>
            <div class="border border-gray-900">
              ...
              <div class="flex justify-center">
                <template
                  ...
                  :key="index"
                >
                  <div class="w-6 h-8 border border-gray-900 flex items-center justify-center">
                    {{ char }}
                  </div>
                </template>
              </div>
            ...
            <div class="border border-gray-900 mt-2">
              ...
              <p class="h-8 border border-gray-900 font-semibold pt-1 text-center justify-center">
