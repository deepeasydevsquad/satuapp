...
// Import Icon
import DeleteIcon from '@/modules/Kostumer/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/Kostumer/Icon/EditIcon.vue';
import Pagination from '@/components/Pagination/Pagination.vue';
// import element
import PrimaryButton from '@/components/Button/PrimaryButton.vue';
import DangerButton from '@/modules/Kostumer/Particle/DangerButton.vue';
import Notification from '@/modules/Kostumer/Particle/Notification.vue';
import Confirmation from '@/modules/Kostumer/Particle/Confirmation.vue';
import LightButton from '@/modules/DaftarPaketLa/Particle/LightButton.vue';
...
const openModal = (kostumer?: Kostumer) => {
  selectedKostumer.value = kostumer
    ? { ...kostumer }
...
<template>
  <div class="container mx-auto p-4">
    ...
    <Form
      ...
      :label="selectedKostumer.id ? 'Edit Data Kostumer' : 'Tambah Kostumer Baru'"
      width="sm:w-full sm:max-w-md"
      @close="isModalOpen = false"
      @cancel="isModalOpen = false"
      @submit="saveData"
      :submitLabel="selectedKostumer.id ? 'SIMPAN PERUBAHAN' : 'TAMBAH'"
    >
      <div class="space-y-4">
        <div>
