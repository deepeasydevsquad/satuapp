...
<template>
  ...
  >
    ...
    >
      ...
      >
      <div
        class="relative inline-block transform overflow-hidden rounded-lg bg-white text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl sm:align-middle p-6"
      >
        <!-- Title -->
          ...
          <div class="overflow-y-auto no-scrollbar px-1">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-800 sm:min-h-[320px]">
              ...
              <div>
                ...
                <input
                  type="date"
                  v-model="form.tanggal_di_keluarkan_passport"
                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
              <div>
                ...
                <input
                  type="text"
                  v-model="form.tempat_di_keluarkan_passport"
                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                  placeholder="Masukkan tempat di keluarkan passport"
                />
              </div>
              <div>
                ...
                <input
                  type="date"
                  v-model="form.masa_berlaku_passport"
                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
                />
              </div>
            </div>
