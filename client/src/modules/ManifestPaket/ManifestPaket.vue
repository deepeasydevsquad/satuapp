...
// Import icon
import EditIcon from '@/modules/ManifestPaket/icon/EditIcon.vue';
import DownloadIcon from '@/modules/ManifestPaket/icon/DownloadIcon.vue';

// import element
import LightButton from '@/components/Button/LightButton.vue';
import EditButton from '@/modules/ManifestPaket/particle/EditButton.vue';
import Notification from '@/modules/ManifestPaket/particle/Notification.vue';
  ...
  >
    <FormUpdate
      ...
      @status="
        (payload) =>
          displayNotification(
            payload.err_msg || 'Data Jamaah gagal diperbarui',
