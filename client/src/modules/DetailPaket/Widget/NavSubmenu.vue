...
import BackButton from '@/modules/DetailPaket/Particle/BackButton.vue';
import SubmenuItem from '@/modules/DetailPaket/Particle/SubmenuItem.vue';
        ...
        <button
          ...
          :class="
            current === item.value
              ...
              : 'text-gray-700 hover:bg-gray-100 border-e'
          "
          class="px-4 py-2 w-30 text-sm font-medium bg-white border border-gray-200 rounded-e-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 dark:bg-gray-800 dark:border-gray-700 dark:text-white dark:hover:text-white dark:hover:bg-gray-700 dark:focus:ring-blue-500 dark:focus:text-white"
        >
