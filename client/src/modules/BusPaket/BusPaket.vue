...
import EditIcon from '@/modules/BusPaket/Icon/EditIcon.vue';
import DeleteIcon from '@/modules/BusPaket/Icon/DeleteIcon.vue';
import Pagination from '@/components/Pagination/Pagination.vue';
import PrimaryButton from '@/components/Button/PrimaryButton.vue';

import LightButton from '@/components/Button/LightButton.vue';
import DangerButton from '@/components/Button/DangerButton.vue';
import Notification from '@/modules/BusPaket/Particle/Notification.vue';
import Confirmation from '@/modules/BusPaket/Particle/Confirmation.vue';

import { getDaftarBusPaket, deleteBus } from '@/service/bus_paket';
import { ref, onMounted, computed } from 'vue';

import FormAddUpdate from '@/modules/BusPaket/Widget/FormAddUpdate.vue';
