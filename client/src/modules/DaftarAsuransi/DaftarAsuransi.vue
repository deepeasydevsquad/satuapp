...
// Import Icon
import DeleteIcon from '@/modules/DaftarAsuransi/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/DaftarAsuransi/Icon/EditIcon.vue';

// import element
import Form from '@/modules/DaftarAsuransi/Widget/Form.vue';
import DangerButton from '@/modules/DaftarAsuransi/Particle/DangerButton.vue';
import Notification from '@/modules/DaftarAsuransi/Particle/Notification.vue';
import Confirmation from '@/modules/DaftarAsuransi/Particle/Confirmation.vue';
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          ...
          <tr v-else>
            <td colspan="2" class="px-6 py-4 text-center text-base text-gray-600">
              Daftar asuransi tidak ditemukan.
            </td>
          </tr>
        </tbody>
    ...
    >
      <Form
        ...
        @status="
          (payload) =>
            displayNotification(
              payload.err_msg || 'Tambah atau Update Asuransi gagal',
