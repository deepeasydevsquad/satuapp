...
import ModalAdd from '@/modules/Grup/Particle/ModalAdd.vue';
import ModalUpdate from '@/modules/Grup/Particle/ModalUpdate.vue';
import { daftarGrup, addGrup, editGrup, hapusGrup } from '@/service/grup';
import DeleteIcon from '@/modules/Grup/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/Grup/Icon/EditIcon.vue';
import Notification from '@/modules/Grup/Particle/Notification.vue';
import Confirm from '@/modules/Grup/Particle/ModalConfirmDelete.vue';
                  ...
                  <ol class="list-disc list-inside space-y-1">
                    <li v-for="access in grup?.group_access" :key="access.id">
                      ...
                      <ul v-if="grup?.group_access.length > 0" class="list-none list-inside pl-5">
                        <li
                          v-for="submenu in access.submenu"
                          :key="submenu.id"
