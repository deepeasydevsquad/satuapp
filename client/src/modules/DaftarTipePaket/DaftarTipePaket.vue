...
import DeleteIcon from '@/modules/DaftarTipePaket/Icon/DeleteIcon.vue';
import EditIcon from '@/modules/DaftarTipePaket/Icon/EditIcon.vue';
import DangerButton from '@/modules/DaftarTipePaket/Particle/DangerButton.vue';
import Notification from '@/modules/DaftarTipePaket/Particle/Notification.vue';
import Confirmation from '@/modules/DaftarTipePaket/Particle/Confirmation.vue';
...
import {
  ...
  editTipePaket,
  deleteTipePaket,
} from '@/service/daftar_tipe_paket'; // Import function POST
...
const fetchData = async () => {
  try {
    const response = await daftarTipePaket({
      search: search.value,
...
const openModal = (tipe_paket?: TipePaket) => {
  selectedTipePaket.value = tipe_paket ? { ...tipe_paket } : { name: '' };
...
<template>
  <div class="container mx-auto px-4 mt-10">
    ...
    <Form
      ...
      :label="selectedTipePaket.id ? 'Edit Data Tipe Paket' : 'Tambah Tipe Paket Baru'"
      width="sm:w-full sm:max-w-md"
      @close="isModalOpen = false"
      @cancel="isModalOpen = false"
      @submit="saveData"
      :submitLabel="selectedTipePaket.id ? 'SIMPAN PERUBAHAN' : 'TAMBAH'"
    >
      <div class="space-y-4">
        <div>
