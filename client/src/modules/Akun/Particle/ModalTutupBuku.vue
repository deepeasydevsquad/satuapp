            ...
            <div class="space-y-4">
              <div>
                <label class="block text-sm font-medium text-gray-700 mb-1"
                  >Nama Periode Sekarang</label
                >
                <input
                  class="w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 text-gray-600 font-normal"
                  placeholder="Nama Periode Sekarang"
                  type="text"
                  id="rupiah"
                  v-model="dataTutupBuku.nama_periode"
                />
                <p v-if="errors_message.nama_periode" class="mt-1 text-sm text-red-600">
                  {{ errors_message.nama_periode }}
                </p>
              </div>
            </div>
          </div>
