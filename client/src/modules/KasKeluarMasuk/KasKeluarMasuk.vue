...
import FormAddUpdate from '@/modules/KasKeluarMasuk/Widget/FormAddUpdate.vue';
...
<template>
  <div class="container mx-auto px-4 mt-10">
    ...
    <div class="flex justify-between mb-6">
      <PrimaryButton @click="addKasKeluarMasuk()"
        ><IconPlus /> Tambah Transaksi Keluar Masuk</PrimaryButton
      >
      ...
      <table class="w-full border-collapse bg-white text-left text-sm text-gray-500">
        <thead class="bg-gray-100">
          <tr>
            ...
            <th class="w-[15%] px-6 py-3 font-medium text-gray-900 text-center">
              Tanggal Transaksi
            </th>
        ...
        <tbody class="divide-y divide-gray-100 border-t border-gray-100">
          <template v-if="datas && datas.length > 0">
            <tr v-for="data in datas" :key="data.id" class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 text-center">
                {{ data.status_kwitansi == 'masuk' ? 'MASUK' : 'KELUAR' }}
              </td>
          ...
          <tr v-else>
            <td colspan="6" class="px-6 py-3 text-center text-sm text-gray-600">
              Daftar Transaksi Keluar Masuk Tidak Ditemukan.
            </td>
          </tr>
        </tbody>
    ...
    <!-- Modal Form -->
    <FormAddUpdate
      :showForm="showAddUpdate"
      :id="id"
      @cancel="closeForm"
      @save="saveAddUpdateForm"
    />
