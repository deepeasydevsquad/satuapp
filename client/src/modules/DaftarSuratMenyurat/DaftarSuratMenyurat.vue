...
import ModalTambahSurat from '@/modules/DaftarSuratMenyurat/widgets/ModalTambahSurat.vue';
import ModalKonfigurasi from '@/modules/DaftarSuratMenyurat/widgets/ModalKonfigurasi.vue';
