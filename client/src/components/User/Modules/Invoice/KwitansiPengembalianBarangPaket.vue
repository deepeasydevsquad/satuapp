...
import { getKwitansiPengembalianBarangPaket } from '@/service/invoice.ts'
...
const fetchData = async () => {
  try {
    ...
    const response = await getKwitansiPengembalianBarangPaket(invoice.toString())
    ...
    <div v-if="!isLoading && data">
      ...
      <div class="flex justify-between items-start">
        ...
        <div class="text-center font-semibold text-lg">
          BUKTI KWITANSI PENGEMBALIAN BARANG
        </div>
      </div>
