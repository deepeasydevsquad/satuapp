...
const controllers = require("../modules/riwayat_mutasi_saldo_perusahaan/controllers/index");
const { authenticateToken } = require("../middleware/authenticateToken");
// const validation = require("../validation/riwayat_mutasi_saldo_perusahaan");

const router = express.Router();

router.post(
  "/riwayat_mutasi_saldo_perusahaan/list",
  authenticateToken,
  [
    body("pageNumber")
      .trim()
