...
const controllers = require("../modules/backbone/controllers/index");
const {
  authenticateTokenBackbone,
} = require("../middleware/authenticateToken");
const validation = require("../validation/backbone");
...
router.get("/backbone", authenticateTokenBackbone, controllers.backbone);
